                        ...
                        <nav  class="v-toolbar v-toolbar--fixed theme--dark primary" style="margin-top: 0px; padding-right: 0px; padding-left: 0px; transform: translateY(0px);"
                            ...
                            <div class="v-toolbar__content" style="height: 64px;">
                                <div  class="v-list__tile__avatar">
                                    <div  class="v-avatar" style="height: 40px; width: 40px;"><img  src="http://bizakula.ru/storage/logo/temp_shark_logo.png"
                                            alt="Бизнес - Акула" class="img_logo"></div>
                                </div>
                                <div  class="v-toolbar__title"><a target="_blank" href="http://bizakula.ru" class="logo">Бизнес - Акула</a></div>
                        ...
                        <div class="wrapper">
                            <div class="container">
                                <div class="layout justify-center align-center">
                                    <div class="flex xs6">
                                        <h1>{{$name}}, Спасибо за регистрацию на сайте <a target="_blank" href="http://bizakula.ru">Бизнес - Акула</a></h1>
                                        <h3>Для подстверждения регистарции пройдите по <a target="_blank" href="http://bizakula.ru/app/verifyemail/{{$email_token}}">ссылке</a>.</h3>
                                    </div>
                                </div>
                            </div>
                        </div>
